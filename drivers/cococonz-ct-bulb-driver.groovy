...
metadata {
   definition (name: "CoCoConz CT Bulb", namespace: "RMoRobert", author: "Robert Morris", importUrl: "https://raw.githubusercontent.com/RMoRobert/CoCoConz/main/drivers/cococonz-ct-bulb-driver.groovy") {
      capability "Actuator"
   ...
   preferences {
      ...
      input name: "colorStaging", type: "bool", description: "", title: "Enable color temperature pseudo-prestaging", defaultValue: false
