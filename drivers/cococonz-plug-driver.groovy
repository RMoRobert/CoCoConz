/*
 * =============================  CoCoConz On/Off Plug/Light (Driver) ===============================
 *
...
metadata {
   definition (name: "CoCoConz On/Off Plug", namespace: "RMoRobert", author: "Robert Morris", importUrl: "https://raw.githubusercontent.com/RMoRobert/CoCoConz/main/drivers/cococonz-plug-driver.groovy") {
      capability "Actuator"
      capability "Refresh"
      capability "Switch"
      capability "Light"
