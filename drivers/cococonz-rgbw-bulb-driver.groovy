...
metadata {
   definition (name: "CoCoConz RGBW Bulb", namespace: "RMoRobert", author: "Robert Morris", importUrl: "https://raw.githubusercontent.com/RMoRobert/CoCoConz/main/drivers/cococonz-rgbw-bulb-driver.groovy") {
      capability "Actuator"
...
/**
  ...
  * last CT sent from Hubitat if this happens.
  */
void verifyCT() {
   ...
   if (lastCT[device.id] && device.currentValue("colorMode") == "CT") {
      ...
      // Give a 2K threshold for rounding errors, etc.
